...
namespace Emu.Tests.Audio.Formats.FLAC
{
    ...
    {
        private static readonly ValueTuple<byte[], FrameHeader>[] ValidFramesValue = new[]
        {
        ...
        private static readonly ValueTuple<byte[], string>[] InvalidFramesValue = new[]
        {
        ...
        public static IEnumerable<object[]> ValidFrames => ValidFramesValue.Select((x, i) => new object[] { i });

        public static IEnumerable<object[]> InvalidFrames => InvalidFramesValue.Select((x, i) => new object[] { i });
        ...
        [Theory]
        [MemberData(nameof(ValidFrames))]
        public void ParseWorks(int index)
        {
            var (frameHeader, expected) = ValidFramesValue[index];
        ...
        public void ParseFailsWithBadData(int index)
        {
            var (frameHeader, expectedError) = InvalidFramesValue[index];
